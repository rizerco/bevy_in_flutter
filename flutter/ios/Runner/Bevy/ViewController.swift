...
class ViewController: UIViewController {
	...
	override func loadView() {
		...
		self.metalView.topAnchor.constraint(equalTo: self.view.topAnchor).isActive = true
		self.metalView.bottomAnchor.constraint(equalTo: self.view.bottomAnchor).isActive = true
		self.metalView.leadingAnchor.constraint(equalTo: self.view.leadingAnchor).isActive = true
		self.metalView.trailingAnchor.constraint(equalTo: self.view.trailingAnchor).isActive = true
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
        if let bevy = self.bevyApp, let touch: UITouch = touches.first {
            let location = touch.location(in: self.metalView);
