...
if [ ! -d "../flutter/macos/libs/${LIB_FOLDER}/" ]; then
  mkdir -p "../flutter/macos/libs/${LIB_FOLDER}"
fi

cp target/${TARGET}/${LIB_FOLDER}/libbevy_in_app.a ../flutter/macos/libs/${LIB_FOLDER}/libbevy_in_app.a
