...
if [ ! -d "../flutter/ios/libs/${LIB_FOLDER}/" ]; then
  mkdir -p "../flutter/ios/libs/${LIB_FOLDER}"
fi

cp target/${TARGET}/${LIB_FOLDER}/libbevy_in_app.a ../flutter/ios/libs/${LIB_FOLDER}/libbevy_in_app.a
